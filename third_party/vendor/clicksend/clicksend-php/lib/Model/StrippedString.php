...
/**
 * StrippedString Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StrippedString implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StrippedString';
    ...
    {
        $this->container['strip_string'] = isset($data['strip_string']) ? $data['strip_string'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['strip_string'] === null) {
            $invalidProperties[] = "'strip_string' can't be null";
        }
     ...
     * Sets strip_string
     *
     * @param string $strip_string String to be.
     *
     * @return $this
     */
