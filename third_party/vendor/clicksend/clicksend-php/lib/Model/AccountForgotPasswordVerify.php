 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountForgotPasswordVerify implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountForgotPasswordVerify';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activation_token'] === null) {
            $invalidProperties[] = "'activation_token' can't be null";
        }
     ...
     * Sets subaccount_id
     *
     * @param int $subaccount_id ID of subaccount
     *
     * @return $this
     */
