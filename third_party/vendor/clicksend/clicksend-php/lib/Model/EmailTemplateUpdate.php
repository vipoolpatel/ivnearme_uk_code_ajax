 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailTemplateUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailTemplateUpdate';
     ...
     * Sets template_name
     *
     * @param string $template_name The intended name for the template.
     *
     * @return $this
     */
     ...
     * Sets body
     *
     * @param string $body Your template body.
     *
     * @return $this
     */
