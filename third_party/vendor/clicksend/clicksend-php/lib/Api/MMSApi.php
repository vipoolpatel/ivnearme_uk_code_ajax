...
class MMSApi
{
     ...
     * @return string
     */
    public function mmsReceiptsGet($page = '1', $limit = '10')
    {
        list($response) = $this->mmsReceiptsGetWithHttpInfo($page, $limit);
        return $response;
    }

    /**
     * Operation mmsReceiptsGetWithHttpInfo
     *
     * Get all delivery receipts
     *
     * @param  int $page Page number (optional, default to 1)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function mmsReceiptsGetWithHttpInfo($page = '1', $limit = '10')
    {
        $returnType = 'string';
        $request = $this->mmsReceiptsGetRequest($page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mmsReceiptsGetAsync($page = '1', $limit = '10')
    {
        return $this->mmsReceiptsGetAsyncWithHttpInfo($page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation mmsReceiptsGetAsyncWithHttpInfo
     *
     * Get all delivery receipts
     *
     * @param  int $page Page number (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mmsReceiptsGetAsyncWithHttpInfo($page = '1', $limit = '10')
    {
        $returnType = 'string';
        $request = $this->mmsReceiptsGetRequest($page, $limit);
    ...
    /**
     * Create request for operation 'mmsReceiptsGet'
     *
     * @param  int $page Page number (optional, default to 1)
     * @param  int $limit Number of records per page (optional, default to 10)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mmsReceiptsGetRequest($page = '1', $limit = '10')
    {
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling MMSApi.mmsReceiptsGet, must be bigger than or equal to 1.');
        }

        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MMSApi.mmsReceiptsGet, must be bigger than or equal to 1.');
        }


        $resourcePath = '/mms/receipts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return string
     */
    public function mmsReceiptsReadPut($date_before = null)
    {
        list($response) = $this->mmsReceiptsReadPutWithHttpInfo($date_before);
        return $response;
    }

    /**
     * Operation mmsReceiptsReadPutWithHttpInfo
     *
     * Mark delivery receipts as read
     *
     * @param  \ClickSend\Model\DateBefore $date_before DateBefore model (optional)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function mmsReceiptsReadPutWithHttpInfo($date_before = null)
    {
        $returnType = 'string';
        $request = $this->mmsReceiptsReadPutRequest($date_before);
    ...
    /**
     * Operation mmsReceiptsReadPutAsync
     *
     * Mark delivery receipts as read
     *
     * @param  \ClickSend\Model\DateBefore $date_before DateBefore model (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mmsReceiptsReadPutAsync($date_before = null)
    {
        return $this->mmsReceiptsReadPutAsyncWithHttpInfo($date_before)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation mmsReceiptsReadPutAsyncWithHttpInfo
     *
     * Mark delivery receipts as read
     *
     * @param  \ClickSend\Model\DateBefore $date_before DateBefore model (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mmsReceiptsReadPutAsyncWithHttpInfo($date_before = null)
    {
        $returnType = 'string';
        $request = $this->mmsReceiptsReadPutRequest($date_before);
    ...
    /**
     * Create request for operation 'mmsReceiptsReadPut'
     *
     * @param  \ClickSend\Model\DateBefore $date_before DateBefore model (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mmsReceiptsReadPutRequest($date_before = null)
    {

        $resourcePath = '/mms/receipts-read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
