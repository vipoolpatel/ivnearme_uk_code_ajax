...
/**
 * DetectAddressApi Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   ClickSend Codegen team
...
class DetectAddressApi
{
    ...
    /**
     * Operation detectAddressPostWithHttpInfo
     *
     * Detects address in uploaded file.
     *
     * @param  \ClickSend\Model\UploadFile $upload_file Your file to be uploaded (required)
    ...
    /**
     * Operation detectAddressPostAsync
     *
     * Detects address in uploaded file.
     *
     * @param  \ClickSend\Model\UploadFile $upload_file Your file to be uploaded (required)
    ...
    /**
     * Operation detectAddressPostAsyncWithHttpInfo
     *
     * Detects address in uploaded file.
     *
     * @param  \ClickSend\Model\UploadFile $upload_file Your file to be uploaded (required)
    ...
    protected function detectAddressPostRequest($upload_file)
    {
        ...
        $resourcePath = '/post/letters/detect-address';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
