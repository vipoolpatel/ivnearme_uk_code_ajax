...
class CountriesApi
{
    ...
    {
        $returnType = 'string';
        $request = $this->countriesGetRequest();
     ...
     */
    public function countriesGetAsync()
    {
        return $this->countriesGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countriesGetAsyncWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->countriesGetRequest();
     ...
     */
    protected function countriesGetRequest()
    {
