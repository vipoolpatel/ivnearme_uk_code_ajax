                         ...
                         <div class="col-md-12">
                           <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control ChangeStatusNurse" style="width: 150px;" id="<?=$getOrder->id?>">
                                            <option value="">Select Nurse</option>
                                            <?php
                                            foreach ($getNurse as $value_n)
                                            { ?>
                                            <option <?=($value_n->id == $getOrder->nurse_id)?'selected':''?> value="<?=$value_n->id?>"><?=$value_n->name?></option>
                                           <?php }
                                            ?>
                                        </select>
                                    </div>
...
?>     
           ...
           <script type="text/javascript">
               $('.ChangeStatusNurse').change(function(){
                var id = $(this).attr('id');
                var value = $(this).val();
                $.ajax({
                        type:'POST',
