    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">                    
                <h2><span class="fa fa-arrow-circle-o-left"></span> Pending Order List</h2>
            </div>  
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Pending Order Search</h3>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <form action="" method = "get">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?= base_url() ?>panel/order/pending/0" class="btn btn-success">Reset</a>
                                    </div>
                                </form>
                            </div> 
                         </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Pending Order List</h3>
                        </div>
