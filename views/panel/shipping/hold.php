        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Hold Shipping List</h2>
                </div>
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php } ?>
                             <a href="<?=base_url()?>panel/shipping/add_shipping" class="btn btn-primary" title="Add New Shipping"><i class="fa fa-plus"></i>&nbsp;&nbsp;<span class="bold">Add New Order</span></a>
                              <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Hold Shipping Search</h3>
                                </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="<?=base_url()?>panel/shipping/hold/0" class="btn btn-success">Reset</a>
                                </div>
                                </form>
                             </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                 <div class="panel-heading">
                                    <h3 class="panel-title">Hold Shipping List</h3>
                                </div>
